    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-32 cursor-deafult">
            ...
            <div className="space-y-16">
                <div>
                    <h2 className="text-xl text-base-content/80 text-center mb-8 font-bold">Our Expertise</h2>
                    <div className="grid grid-col-1 md:grid-cols-2 md:max-w-4xl gap-8 text-base-content/60 text-lg cursor-default">
                        <div className="flex flex-col group items-center text-center md:items-start md:text-start">

                            <svg className="w-8 h-8 mb-2 group-hover:text-secondary duration-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m8 8-4 4 4 4m8 0 4-4-4-4m-2-3-4 14" />
                            </svg>

                            <div>
                                <span className="text-base-content group-hover:text-secondary duration-300 font-semibold">Website Development. </span>
                        ...
                        <div className="flex flex-col group items-center text-center md:items-start md:text-start">
                            ...
                            <div>
                                <span className="text-base-content group-hover:text-secondary duration-300 font-semibold">CRM Development. </span>
                        ...
                        <div className="flex flex-col group items-center text-center md:items-start md:text-start">
                            ...
                            <div>
                                <span className="text-base-content group-hover:text-secondary duration-300 font-semibold">Marketing Services. </span>
                        ...
                        <div className="flex flex-col group items-center text-center md:items-start md:text-start">
                            ...
                            <div>
                                <span className="text-base-content group-hover:text-secondary duration-300 font-semibold">Phone System Setup. </span>
                ...
                <div className="flex flex-col max-w-4xl mx-auto items-center">
                    <h2 className="text-xl text-base-content/80 font-bold mb-8">Why Choose Us?</h2>
                    <div className="text-base-content/60 text-lg">
